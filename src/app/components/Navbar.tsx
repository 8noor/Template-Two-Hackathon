    ...
    <nav className="bg-white p-4">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-6">
          ...
          {/* Links */}
          <Link
            href="http://localhost:3000/Home1"
      ...
      <div className="max-w-7xl mx-auto flex justify-center space-x-10 py-2">
        <Link
          href="http://localhost:3000/Product2"
          className="text-gray-400 hover:text-gray-500"
        >
          Plant Pots
        </Link>
        <a href="#ceramics" className="text-gray-400 hover:text-gray-500">
          Ceramics
        </a>
        <a href="#tables" className="text-gray-400 hover:text-gray-500">
          Tables
        </a>
        <Link
          href="ProductListing"
        ...
        <a href="#crockery" className="text-gray-400 hover:text-gray-500">
          Crockery
        </a>
        <a href="#tableware" className="text-gray-400 hover:text-gray-500">
          Tableware
        </a>
        <a href="#cutlery" className="text-gray-400 hover:text-gray-500">
          Cutlery
        </a>
      </div>
