                ...
                <div className="flex justify-center md:justify-start">
                  <Link href={"http://localhost:3000/Product2"}>
                    <button
                      ...
                      className="w-[140px] h-[56px] bg-transparent text-white border border-gray-600 font-bold mt-12 hover:bg-blue-600 hover:text-white active:bg-blue-800 transition duration-300"
                    >
                      View collection
                    </button>
                  </Link>
